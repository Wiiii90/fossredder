...
| `ui/include/ui/window/DropController.h` | `ui/include/ui/shell/window/DropController.h` |
| `ui/src/window/DropController.cpp` | `ui/src/shell/window/DropController.cpp` |
...
| `ui/include/ui/controllers/DraftController.h` | `ui/include/ui/workflows/import/ImportDraftWorkflow.h` |
| `ui/src/controllers/DraftController.cpp` | `ui/src/workflows/import/ImportDraftWorkflow.cpp` |
...
| `ui/include/ui/import/ImportJobBridge.h` | `ui/include/ui/workflows/import/ImportWorkflow.h` |
| `ui/src/import/ImportJobBridge.cpp` | `ui/src/workflows/import/ImportWorkflow.cpp` |
...
| `ui/include/ui/export/ExportRunner.h` | `ui/include/ui/workflows/export/ExportWorkflow.h` |
| `ui/src/export/ExportRunner.cpp` | `ui/src/workflows/export/ExportWorkflow.cpp` |
...
Der Name wurde bewusst verworfen.
Die projizierende Rolle wird durch `WorkspaceFacade`, `WorkspaceSessionModels` und konkrete Mappers abgedeckt.
...
Wird bewusst zu `SettingsStore`.
Das `Ui`-Präfix ist hier nur Ballast.
