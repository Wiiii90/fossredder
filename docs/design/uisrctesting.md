...
## Purpose
This document collects the test matrix for the UI source layer that sits between QML and core: the list models, controllers, and QML view logic for Actor, Property, and Contract.

It focuses on parity, determinism, and contract correctness across the UI model stack.
