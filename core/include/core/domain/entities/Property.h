...
public:
    ...
    /**
     * @brief Renames the property with normalized entity text.
     * @param value Normalized entity name wrapper.
     */
    void rename(EntityName value);
    /**
     * @brief Renames the property with raw text.
    ...
    /**
     * @brief Clears all aliases from the property.
     */
    void clearAliases();
    ...
    /**
     * @brief Checks whether an alias exists on the property.
