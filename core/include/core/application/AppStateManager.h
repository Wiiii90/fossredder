 ...
 * @brief Loader/saver for core::domain::AppState using repository abstractions.
 *
 * Responsible for converting between repository data and the in-memory
 * core::domain::AppState representation. Provides load/save and validation/rehydration logic.
 */
...
public:
    ...
    void save(const core::domain::AppState& state);
