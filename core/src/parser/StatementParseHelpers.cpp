    ...
    try {
        ...
        for (size_t headerIndex = 0; headerIndex < debugCount; ++headerIndex) {
            ...
            try {
                ...
                try { if (seedCols.valutaX >= 0) hasValutaTokenNear = core::parser::helpers::hasTokenNearX(line, seedCols.valutaX, core::parser::helpers::parserConfig.tokenNearBandForMainRow); } catch (...) { core::errors::reportException(core::errors::ErrorSeverity::Warning, "core::parser::DefaultStatementParser::headerCandidateValutaNear", std::current_exception()); }
