/**
 * @file core/src/export/PropertyContractMatrix.h
 * @brief Declares private helpers for building export matrix data from app state.
 */
...
namespace core::exporting::detail {
