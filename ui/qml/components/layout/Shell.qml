...
GridLayout {
    ...
    Loader {
        ...
        asynchronous: false
        Layout.row: 0
        Layout.preferredHeight: toolbarLoader.item ? toolbarLoader.item.implicitHeight : 72
        Layout.minimumHeight: toolbarLoader.item ? toolbarLoader.item.implicitHeight : 72
