...
class ActorSelection : public QObject {
    ...
    QML_UNCREATABLE("ActorSelection is exposed by WorkspaceFacade")
...
class PropertySelection : public QObject {
    ...
    QML_UNCREATABLE("PropertySelection is exposed by WorkspaceFacade")
    Q_PROPERTY(QString id READ id NOTIFY changed)
    Q_PROPERTY(QString name READ name NOTIFY changed)
    Q_PROPERTY(QStringList aliases READ aliases NOTIFY changed)
...
class ContractSelection : public QObject {
    ...
    QML_UNCREATABLE("ContractSelection is exposed by WorkspaceFacade")
    Q_PROPERTY(QString id READ id NOTIFY changed)
    Q_PROPERTY(QString name READ name NOTIFY changed)
...
class StatementSelection : public QObject {
    ...
    QML_UNCREATABLE("StatementSelection is exposed by WorkspaceFacade")
    Q_PROPERTY(QString id READ id NOTIFY changed)
    Q_PROPERTY(QString name READ name NOTIFY changed)
...
class TransactionSelection : public QObject {
    ...
    QML_UNCREATABLE("TransactionSelection is exposed by WorkspaceFacade")
    Q_PROPERTY(QString id READ id NOTIFY changed)
    Q_PROPERTY(QString name READ name NOTIFY changed)
...
class AnalysisSelection : public QObject {
    ...
    QML_UNCREATABLE("AnalysisSelection is exposed by WorkspaceFacade")
    Q_PROPERTY(QString id READ id NOTIFY changed)
    Q_PROPERTY(QString name READ name NOTIFY changed)
    Q_PROPERTY(QString type READ type NOTIFY changed)
...
class AnnualSelection : public QObject {
    ...
    QML_UNCREATABLE("AnnualSelection is exposed by WorkspaceFacade")
    Q_PROPERTY(QString id READ id NOTIFY changed)
    Q_PROPERTY(QString name READ name NOTIFY changed)
