 ...
 * @brief Centralizes translatable UI text helpers used by widgets, workflows and QML bridges.
 */
...
inline constexpr auto kStorageCreateFailedSource = QT_TRANSLATE_NOOP("WorkflowErrors", "Failed to create file");
inline constexpr auto kStorageOpenFailedSource = QT_TRANSLATE_NOOP("WorkflowErrors", "Failed to open file");
inline constexpr auto kStorageSaveFailedSource = QT_TRANSLATE_NOOP("WorkflowErrors", "Failed to save file");
inline constexpr auto kStorageSaveAsFailedSource = QT_TRANSLATE_NOOP("WorkflowErrors", "Failed to save file as");
inline constexpr auto kExportFailedSource = QT_TRANSLATE_NOOP("WorkflowErrors", "Export failed");
inline constexpr auto kExportStateUnavailableSource = QT_TRANSLATE_NOOP("WorkflowErrors", "Export state not available");
inline constexpr auto kImportWorkflowUnavailableSource = QT_TRANSLATE_NOOP("WorkflowErrors", "Import workflow not available");
inline constexpr auto kNoFileSelectedSource = QT_TRANSLATE_NOOP("WorkflowErrors", "No file selected");
inline constexpr auto kImportFailedSource = QT_TRANSLATE_NOOP("WorkflowErrors", "Import failed");
inline constexpr auto kAnalysisEngineUnavailableSource = QT_TRANSLATE_NOOP("WorkflowErrors", "Analysis engine not available");
inline constexpr auto kAnalysisStateUnavailableSource = QT_TRANSLATE_NOOP("WorkflowErrors", "Analysis state not available");
...
inline QString importWorkflowUnavailable() { return detail::translate(kContext, kImportWorkflowUnavailableSource); }
...
inline constexpr auto kTypeStatementSource = QT_TRANSLATE_NOOP("ImportWorkflowState", "Statement");
inline constexpr auto kStatusCanceledSource = QT_TRANSLATE_NOOP("ImportWorkflowState", "Canceled");
...
inline constexpr auto kContext = "ImportWorkflowState";
inline constexpr auto kStoppingSource = QT_TRANSLATE_NOOP("ImportWorkflowState", "Stopping...");
inline constexpr auto kStartingSource = QT_TRANSLATE_NOOP("ImportWorkflowState", "Starting import...");
inline constexpr auto kCanceledSource = QT_TRANSLATE_NOOP("ImportWorkflowState", "Import canceled");
inline constexpr auto kFailedSource = QT_TRANSLATE_NOOP("ImportWorkflowState", "Import failed");
inline constexpr auto kFinishedSource = QT_TRANSLATE_NOOP("ImportWorkflowState", "Import finished");
...
inline constexpr auto kEnglishLabelSource = QT_TRANSLATE_NOOP("LanguageService", "English");
inline constexpr auto kGermanLabelSource = QT_TRANSLATE_NOOP("LanguageService", "Deutsch");
